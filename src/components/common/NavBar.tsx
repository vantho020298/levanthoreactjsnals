                            ...
                            <div className="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
                                ...
                                <a className="dropdown-item" href="/">
                                    <div className="item-thumbnail">
                                        <img src="../../images/faces/face4.jpg" alt="face" className="profile-pic"/>
                                    </div>
                                ...
                                <a className="dropdown-item" href="/">
                                    <div className="item-thumbnail">
                                        <img src="../../images/faces/face2.jpg" alt="face" className="profile-pic"/>
                                    </div>
                                    <div className="item-content flex-grow">
                                ...
                                <a className="dropdown-item" href="/">
                                <div className="item-thumbnail">
                                    <img src="../../images/faces/face3.jpg" alt="face" className="profile-pic"/>
                                </div>
                                <div className="item-content flex-grow">
